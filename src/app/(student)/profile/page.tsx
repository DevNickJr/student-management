    ...
    <div className='p-4 overflow-y-auto'>
      ...
      <div className="p-4 pb-12 bg-white rounded-md">
        ...
        <form className="mb-8 text-sm" onSubmit={handleSubmit}>
          <div className='grid gap-10 md:grid-cols-2 lg:grid-cols-3'>
            <div className='flex flex-col gap-2 text-xs'>
              ...
              <input disabled type="text" name="first_name" id="first_name" className='p-2 text-sm border rounded-md' value={user?.first_name} onChange={(e) => dispatch({type: 'first_name', payload: e.target.value })} />
            </div>
            <div className='flex flex-col gap-2 text-xs'>
              <label htmlFor="middle_name">Middle Name</label>
              <input type="text" name="middle_name" id="middle_name" className='p-2 text-sm border rounded-md' value={user?.middle_name || ''} onChange={(e) => dispatch({type: 'middle_name', payload: e.target.value })} />
            </div>
            <div className='flex flex-col gap-2 text-xs'>
              <label htmlFor="last_name">Last Name</label>
              <input disabled type="text" name="last_name" id="last_name" className='p-2 border rounded-md' value={user?.last_name} onChange={(e) => dispatch({type: 'last_name', payload: e.target.value })} />
            </div>
            <div className='flex flex-col gap-2 text-xs'>
            ...
            <div className='flex flex-col gap-2 text-xs'>
              ...
              <input type="tel" name="phone" id="phone" className='p-2 border rounded-md' value={user?.phone} onChange={(e) => dispatch({type: 'phone', payload: e.target.value })} />
            </div>
            <div className='flex flex-col gap-2 text-xs'>
              <label htmlFor="level">Level</label>
              <input type="text" name="level" id="level" className='p-2 border rounded-md' value={user?.level} onChange={(e) => dispatch({type: 'level', payload: e.target.value })} />
            </div>
            <div className='flex flex-col gap-2 text-xs'>
              <label htmlFor="matric">Matric Number</label>
              <input disabled type="text" name="matric" id="matric" className='p-2 border rounded-md' value={user?.matric_no} onChange={(e) => dispatch({type: 'matric_no', payload: e.target.value })} />
            </div>
            <div className='flex flex-col gap-2 text-xs'>
              <label htmlFor="option">Option</label>
              <input type="text" name="option" id="option" className='p-2 border rounded-md' value={user?.option || ''} onChange={(e) => dispatch({type: 'option', payload: e.target.value })} />
            </div>
          </div>
        ...
        <div className="flex flex-col gap-4 text-xs lg:flex-row">
          ...
          <div className='flex-1 p-4 bg-gray-200 rounded-md'>
            <div className="flex items-center justify-between gap-4 mb-2">
              <h6 className='text-sm font-semibold'>Remove Account</h6>
